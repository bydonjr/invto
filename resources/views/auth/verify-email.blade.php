...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>invto. || verify email</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    ...
    <main class="auth-cover-wrapper">
        <div class="auth-cover-content-inner">
            <div class="auth-cover-content-wrapper">
                <div class="auth-img">
                    <img src="{{ asset('backend/assets/images/auth/auth-cover-reset-bg.svg')}}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
        <div class="auth-cover-sidebar-inner">
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    ...
                    <h4 class="fs-13 fw-bold mb-2">Verify your Email</h4>
                    <p class="fs-12 fw-medium text-muted">Verify your Email to be able to login, let's access our the best recommendation for you.</p>
