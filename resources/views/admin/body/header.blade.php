                                    ...
                                    <div class="tab-content nxl-mega-menu-tabs-content">
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                            <div class="mb-4 rounded-3 border">
                                                <img src="{{ asset('backend/assets/images/banner/mockup.png') }}" alt="" class="img-fluid rounded-3" />
                                            </div>
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="{{ asset('backend/assets/images/general/full-avatar.png') }}" alt="" class="img-fluid full-user-avtar" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-integrations" role="tabpanel">
                                            <div class="row g-lg-4 nxl-mega-menu-integrations">
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/app-store.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/spotify.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/figma.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/shopify.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/paypal.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/gmail.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/dropbox.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/google-drive.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/github.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/gitlab.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/facebook.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/pinterest.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/instagram.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/twitter.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset('backend/assets/images/brand/youtube.png') }}" alt="" class="img-fluid" />
                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                            <div class="row g-4 align-items-center">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="{{ asset('backend/assets/images/banner/1.jpg') }}" alt="" class="img-fluid" />
                                                    </div>
                                                    <div class="mt-4">
                                                    ...
                                                    <div id="carouselResourcesCaptions" class="carousel slide" data-bs-ride="carousel">
                                                        ...
                                                        <div class="carousel-inner rounded-3">
                                                            <div class="carousel-item active">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('backend/assets/images/banner/6.jpg') }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('backend/assets/images/banner/5.jpg') }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('backend/assets/images/banner/4.jpg') }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('backend/assets/images/banner/3.jpg') }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('backend/assets/images/banner/2.jpg') }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset('backend/assets/images/banner/1.jpg') }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                        ...
                                                        <div class="col-xxl-10">
                                                            <div class="row g-4">
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{ asset('backend/assets/images/banner/1.jpg') }}" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{ asset('backend/assets/images/banner/2.jpg') }}" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{ asset('backend/assets/images/banner/3.jpg') }}" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{ asset('backend/assets/images/banner/4.jpg') }}" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                        ...
                                                        <div class="col-xxl-10">
                                                            <div class="row g-4">
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset('backend/assets/images/banner/1.jpg') }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset('backend/assets/images/banner/2.jpg') }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset('backend/assets/images/banner/3.jpg') }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset('backend/assets/images/banner/4.jpg') }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset('backend/assets/images/banner/5.jpg') }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset('backend/assets/images/banner/6.jpg') }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
